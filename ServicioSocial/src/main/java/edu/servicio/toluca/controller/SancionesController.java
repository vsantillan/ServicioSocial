...
public class SancionesController
{
    ...
    public String sancionesAlumno(Model modelo, HttpSession session, HttpServletRequest request)
    {
        ...
        List<Sanciones> listaTodasSanciones = daoSanciones.findAll(ordenamiento);
...
//                }
    ...
    public String detalleSancionAlumno(String nombre, String noControl, Model modelo)
    {
        ...
        VistaAlumno alumno = (VistaAlumno) daoVistaAlumno.findBySpecificField("id", noControl, "equal", null, null).get(0);
        System.out.println("//Nocontrol" + alumno.getId());

        DatosPersonales dpAlumno = (DatosPersonales) daoDatosPersonales.findBySpecificField("alumnoId", alumno, "equal", null, null).get(0);
        System.out.println("//Nomnre" + dpAlumno.getNombre());
        List<Sanciones> listaTodasSanciones = daoSanciones.findBySpecificField("datosPersonalesId", dpAlumno, "equal", null, null);
...
//            if (sancion.getHorasSancion().compareTo(BigInteger.ZERO) > 1) {
        ...
        modelo.addAttribute("catalogoSanciones", daoCatalogoSanciones.findAll());
    ...
    public String catalogoSanciones(Model model, HttpSession session, HttpServletRequest request)
    {
        ...
        {
            System.out.println("Conteo de registros Catalogo Sanciones:" + daoCatalogoSanciones.count());
            ...
            if (daoCatalogoSanciones.findAll().isEmpty())
            {
                return "/Sanciones/catalogoSanciones";
            }
            model.addAttribute("sanciones", daoCatalogoSanciones.findAll());
            return "/Sanciones/catalogoSanciones";
        } else
        {
    ...
    public String editaSancion(String descripcion, String horas, Model modelo, BigDecimal id, HttpSession session, HttpServletRequest request)
    {
        ...
        CatalogoSanciones sancion = (CatalogoSanciones) daoCatalogoSanciones.find(id);
    ...
    String nuevaSancion(Model model, BigDecimal idSancion, String descripcion, BigInteger horas, BigInteger tolerancia, Model modelo, String tipo)
    {
        ...
        if (listaErrores.isEmpty())
        {
            ...
            {
                sancion = (CatalogoSanciones) daoCatalogoSanciones.find(idSancion);
            }
            ...
            try
            {
                if (tipo.equals("nuevo"))
                {
                    daoCatalogoSanciones.create(sancion);
                } else
                {
                    daoCatalogoSanciones.edit(sancion);
                }
    ...
    void asignaSancion(Model model, BigDecimal idSancion, BigDecimal idDatosPersonales, BigInteger horas)
    {
        ...
        DatosPersonales datosPersonales = (DatosPersonales) daoDatosPersonales.find(idDatosPersonales);
        ...
        CatalogoSanciones catalogoSancion = (CatalogoSanciones) daoCatalogoSanciones.find(idSancion);
    ...
    public String quitarSancion(String idSancion, Model model, HttpSession session, HttpServletRequest request)
    {
        ...
        try
        {
            ...
            List<Sanciones> sancion = daoSanciones.findBySpecificField("id", id, "equal", null, null);
            if (!sancion.isEmpty())
            {
                daoSanciones.remove(sancion.get(0));
            }
        } catch (Exception e)
        {
            ...
            String pagoSancionAlumno(Model model, String id, String horas, HttpSession session, HttpServletRequest request)
    {
        ...
        try
        {
            ...
            List<Sanciones> sancion = daoSanciones.findBySpecificField("id", idSancion, "equal", null, null);
            if (!sancion.isEmpty())
            {
                ...
                } else
                {
                    ...
                    daoSanciones.edit(sancion.get(0));
                    model.addAttribute("sancion", sancion.get(0));
                    model.addAttribute("espacio", " ");
                    return "ok";
                }
    ...
    {
        model.addAttribute("catalogoSancion", daoCatalogoSanciones.findAll());
    ...
    String asignarSancionAlumno(Model model, String idSancion, String numeroControl)
    {
        ...
        try
        {
            catSanciones = daoCatalogoSanciones.findBySpecificField("id", idSancion, "equal", null, null);
            alumno = daoVistaAlumno.findBySpecificField("id", numeroControl, "equal", null, null);
        } catch (Exception e)
        {
        ...
        try
        {
            ...
            alumnoDP = daoDatosPersonales.findBySpecificField("alumnoId", alumno, "equal", null, null);
        } catch (Exception e)
        {
            System.out.println("Error: " + e.getMessage());
            model.addAttribute("errorAlumno", "error del sistema");
