...
/**
 * Para que funcione requiere 4 parámetros, 2 de ellos son Facades, el de CatalogoSanciones y el de Sanciones, como 3er parámetro requiere la fecha máxima, pasando esa fecha aplicará la sación, el 4to parámero es el objeto de datos personales a quien se aplicará la sanción, el último parámetro es el nombre en clave de la sanción por ejemplo S01
 ...
 * @param dp  Es el objeto de datos personales al que se le aplicará la sanción
