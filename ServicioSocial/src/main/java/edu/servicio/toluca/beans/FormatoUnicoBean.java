...
public class FormatoUnicoBean {
    ...
    private String numero_i;
    private String numero_e;
     ...
     * @return the numero_i
     */
    public String getNumero_i() {
        return numero_i;
    }

    /**
     * @param numero_i the numero_i to set
     */
    public void setNumero_i(String numero_i) {
     ...
     * @return the numero_e
     */
    public String getNumero_e() {
        return numero_e;
    }

    /**
     * @param numero_e the numero_e to set
     */
    public void setNumero_e(String numero_e) {
    ...
    /**
     * @param entre_calles the entre_calles to set
     */
