                ...
                <core:choose>
                    ...
                    <core:otherwise>
                        <center><h1>Selecciona Plática</h1></center>
                                    ...
                                    <form:form action="folioPlatica.pdf" method="post"  class="form-horizontal" id="formSelecciona" commandName="platica" onsubmit="return marcado();" name="seleccionaPlatica">
