    ...
    <body>  
        <div class="container">
            <div class="row">
                ...
                <div class=" row help-block col-md-12 text-center"><h2 class=""><span class="glyphicon glyphicon-list"></span>&nbsp; Nueva Instancia</h2></div>
                        ...
                        <div class="panel-body">
                            <form:form name="altaOrganizacion" commandName="instancia" class="MyForm" action="gdaAdminAltaOrganizacion.do"  method="POST">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="calle">Tel�fono de Instancia:</label>
                                        <form:input path="telefono" id="telefono" size="20" maxlength="13" class="form-control" placeholder="Ingrese el n�mero telef�nico de la instancia."/><br/>
