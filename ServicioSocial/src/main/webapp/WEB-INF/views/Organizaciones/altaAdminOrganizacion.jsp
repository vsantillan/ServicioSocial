            ...
            <div class="row">
                ...
                <div class="row col-md-8 col-md-offset-3">
                    ...
                    <form:form name="altaOrganizacion" commandName="instancia" class="MyForm" action="gdaAdminAltaOrganizacion.do"  method="POST" style="width:70%;" >
                        ...
                        <div class="form-group">
                            <label for="municipio">Municipio:</label></td>
                        ...
                        <div class="form-group">
                            <label for="ciudad">Ciudad</label></td>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type ="submit" value = "Guardar " class="btn btn-primary col-md-2 col-md-offset-3" /> 
                                <input type ="reset" value = "Limpiar" class="btn btn-primary col-md-2 col-md-offset-2" />
                            </div>
