            ...
            <ul class="nav navbar-nav" role="navigation">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="altaAdminOrganizacion.do" onclick="redirecciona('altaAdminOrganizacion.do');">Alta Instancia</a></li>
                                <li><a href="administrarOrganizaciones.do" onclick="redirecciona('administrarOrganizaciones.do');">Administrar Instancias</a></li>
                            </ul>
                        </li>
                        <li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Poyectos</a>
                            <ul class="dropdown-menu">
                                <li><a href="altaAdminProyectos.do" onclick="redirecciona('altaAdminProyectos.do');">Alta de Proyectos</a></li>                                
                                <li><a href="administrarProyectos.do" onclick="redirecciona('administrarProyectos.do');">Administrar Proyectos</a></li>
                            </ul>
                        </li>
                        <li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Validar</a>
                            <ul class="dropdown-menu">
                                <li><a href="validarOrganizaciones.do" onclick="redirecciona('validarOrganizaciones.do');">Validar Instancias</a></li>
                                <li><a href="validarProyectos.do" onclick="redirecciona('validarProyectos.do');">Validar Proyectos</a></li>  
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="estadisticas.do" onclick="redirecciona('estadisticas.do');">Estad&iacute;sticas</a></li>
                    </ul>
                </li>
