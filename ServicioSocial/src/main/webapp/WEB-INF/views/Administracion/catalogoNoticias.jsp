...
<html>
    <head>
        ...
        <title>Cat&aacute;logo de Noticias</title>
    </head>
    <body class="background" >
        ...
        <div id="contenido">
            ...
            <div style="float:left;width:80%">
                <h1>Cat&aacute;logo de Noticias</h1>
                <p>A continuaci&oacute;n se muestra el catalogo de noticias.</p>
                <div id="tabs">
                    <ul>
                        <li><a href="#nuevaNoticia">Nueva Noticia</a></li>
                        <li><a href="#catalogoNoticias">Cat&aacute;logo de Noticias</a></li>

                    </ul>
                    <div id="catalogoNoticias">
                        <table cellpadding='0' cellspacing='0' border='0' class='display' id="example" width='100%'>
                            ...
                            <tbody>
                                <core:forEach items="${Noticias}" var="current">
                                    <tr class='gradeX'>
