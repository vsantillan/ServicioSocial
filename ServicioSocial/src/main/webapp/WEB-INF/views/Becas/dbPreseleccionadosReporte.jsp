<%-- 
    Document   : dbPreseleccionadosReporte
    Created on : 25/10/2013, 10:33:47 AM
    Author     : Jonny
--%>
...
/*Establecemos la ruta del reporte*/ 
 File reportFile = new File(application.getRealPath("reportes//db aspriantes al programa ssc.jasper")); 
